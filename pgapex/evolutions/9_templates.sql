...
VALUES (25, '<select id="#NAME#" class="form-control" name="#NAME#" style="width: #WIDTH##WIDTH_UNIT#">', '</select>', '<option value="#VALUE#"#SELECTED#>', '</option>', '<script>$(document).ready(function() { $( "##NAME#" ).combobox(); });</script>');
